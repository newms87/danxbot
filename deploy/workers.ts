...
export function buildLaunchCommand(
  ...
  // silently regress to a shared dir (Trello cjAyJpgr). The mkdir+chown
  // in `launchWorkers` below is still mandatory: the static mount needs
  // a writable UID-1000 bind source before compose auto-creates as root.
