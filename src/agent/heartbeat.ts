...
export const HEARTBEAT_SYSTEM_PROMPT = [
  ...
  '- stop: Set to true ONLY when you see a result entry with subtype "error" or a process exit code.',
  "  NEVER stop due to inactivity alone — the agent may be thinking or processing large files.",
