...
function writeEffortPolicyRule(
  ...
  const tableRows = levels
    ...
    .join("\n");
  const body =
    `<!-- AUTO-GENERATED by danxbot — do not edit. Source: <repo>/.danxbot/settings.json effortLevels + effortAssignmentPrompt -->\n` +
    `\n` +
    `# Effort Policy\n` +
    `\n` +
    ...
    `\n` +
    `${prompt}\n`;
  writeFileSync(resolve(target.rulesDir, "danx-effort-policy.md"), body);
}
